...
export const loadRecipe = async function (id) {
  try {
    ...
    // Set boolean to either true or false.
...
/**
 * Bookmark
 * > Add item to bookmark array.
 *
 * > Delete item from bookmark array with id.
 */
